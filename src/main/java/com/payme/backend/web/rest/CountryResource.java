...
/**
 * REST controller for managing {@link com.payme.backend.domain.Country}.
 */
@RestController
...
public class CountryResource {
    ...
    public ResponseEntity<List<CountryDTO>> getAllCountries(
        ...
        if ("customer-is-null".equals(filter)) {
            log.debug("REST request to get all Countrys where customer is null");
            return new ResponseEntity<>(countryService.findAllWhereCustomerIsNull(), HttpStatus.OK);
        }

        if ("operator-is-null".equals(filter)) {
            log.debug("REST request to get all Countrys where operator is null");
            return new ResponseEntity<>(countryService.findAllWhereOperatorIsNull(), HttpStatus.OK);
        }
