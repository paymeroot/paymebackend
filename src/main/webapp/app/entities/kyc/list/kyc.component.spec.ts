...
import { sampleWithRequiredData } from '../kyc.test-samples';
...
describe('Kyc Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.kycs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to kycService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getKycIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getKycIdentifier).toHaveBeenCalledWith(entity);
